...
WebUI.click(findTestObject('Object Repository/Page_Amazon.in Shopping Cart/input_submit.save-for-later.62e6d924-74a7-4_09abea'))

WebUI.click(findTestObject('Object Repository/Page_Select a delivery address/input_a-button-input'))

WebUI.click(findTestObject('Object Repository/Page_Amazon.in Checkout/h3_3                Offers'))

WebUI.click(findTestObject('Object Repository/Page_Amazon.in Checkout/h3_4        Items and delivery'))
